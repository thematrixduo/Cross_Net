...
def load(data_path,max_num_images):
  ...
  ###load negative first;
    image_folder=data_path+data_folder+'/patch_5'
    label_folder=data_path+data_folder+'/label_5'
    ...
    assert image_index == label_index, (
          'images.shape: %s labels.shape: %s folder: %s' % (image_index,
                                                 label_index,data_folder))        
...
data_sets=read_data_sets('data_5/')
